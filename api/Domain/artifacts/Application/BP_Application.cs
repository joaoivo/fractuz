...
public static class BP_Application{
	public static List<EN_Application>? Select(IConfiguration config, Guid? SystemIDX=null,string? name=null,string? description=null, String? columnsOrderBy=null, int? pageNumber = null, int? pageRowCount=null ){
		...
		return (List<EN_Application>?)DA_Application.Select(config,out totalRowCount, out seachRowCount, out searchPageCount, out query , ref pageNumber , ref pageRowCount, columnsOrderBy,SystemIDX, name, description);
	}
	public static List<EN_Application>? Select(IConfiguration config,out int? totalRowCount, out int? seachRowCount, out int? searchPageCount, out string? query
		,Guid? SystemIDX=null,string? name=null,string? description=null, String? columnsOrderBy=null, int? pageNumber = null, int? pageRowCount=null ){

		List<EN_Application>? application_lst = (List<EN_Application>?)DA_Application.Select(config,out totalRowCount, out seachRowCount, out searchPageCount, out query, ref pageNumber , ref pageRowCount, columnsOrderBy,SystemIDX, name,description);
