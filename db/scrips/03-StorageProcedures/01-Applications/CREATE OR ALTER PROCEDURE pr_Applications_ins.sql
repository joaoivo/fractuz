USE fractuz
GO
CREATE OR ALTER PROCEDURE pr_Applications_ins
...
BEGIN TRY
	...
	INSERT INTO [fractuz].[dbo].[tbApplications](
		[SystemIDX]	,[Name]	,[Description]	,[SystemCreationUser] 
	) VALUES(
		@rGuid		,@pName	,@pDescription	,@pSystemCreationUser
	)
